      ...
      <div className={type === 'list' ? 'header-container listMode' : 'header-container'}>
        ...
        <div className="header-search">
          ...
          <div className="header-search-item">
            ...
            <span onClick={() => setOpenOptions(!openOptions)} className='search-text'>{`${options.adult} adult(s) - ${options.children} children - ${options.room} room(s)`}</span>
            {openOptions && <div className="options">
              <div className="option-item">
                ...
                <div className="option-counter">
                  ...
                  <button 
                    disabled={options.adult <= 1} className='option-counter-btn' 
