    ...
    <div>
      ...
      <div className="hotel-container">
        ...
        <div className="hotel-wrapper">
          <button className="book-now">Reserve / Book Now</button>
          <h1 className="hotel-title">Grand Hotel</h1>
          <div className="hotel-address">
            <FontAwesomeIcon icon={faLocationDot} />
            <span>Elton St 125 New York</span>
          </div>
          <span className='hotel-distance'>Excellent Location - 25 miles from center</span>
          <span className='hotel-price'>Book a stay at this property with a free airport shuttle</span>
          ...
          <div className="hotel-details">
            ...
            <div className="hotel-details-price">
              ...
              <span>Located in the heart of Krakow, this location has an excellent score of 9.3 </span>
              <h2><b>$825</b> (5 nights)</h2>
